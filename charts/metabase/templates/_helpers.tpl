...
*/}}
{{- define "metabase.deploymentName" -}}
{{- include "metabase.fullname" . }}
{{- end }}
...
*/}}
{{- define "metabase.configMapName" -}}
{{- include "metabase.fullname" . }}-config
{{- end }}
...
{{- include "metabase.fullname" . }}-secret
{{- end }}
